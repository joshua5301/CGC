...
def para():
    ...
    parser.add_argument('--cs_smooth_iters', type=int, default=0, help='>0: full Correct & Smooth on the teacher posteriors (smooth iterations)')
    parser.add_argument('--cs_correct', type=int, default=1, help='1: run the Correct step (residual propagation) before Smooth')
    parser.add_argument('--cs_resid', type=str, default='oof', choices=['oof', 'insample'])
    parser.add_argument('--cs_folds', type=int, default=5)
    parser.add_argument('--cs_alpha1', type=float, default=0.8)
    parser.add_argument('--cs_iters', type=int, default=50)
    parser.add_argument('--cs_scale', type=str, default='auto', help='auto (autoscale) or a number')
    parser.add_argument('--cs_alpha2', type=float, default=0.8)
