"""Proposed method only: full Citeseer sweep, tau=1 and dropout=.9."""
import argparse
import itertools
import json
...
def main():
    ...
    p.add_argument('--output', default='/content/drive/MyDrive/GRIP_citeseer_teacher_fisher_full')
    ...
    with logfile.open('w', encoding='utf-8') as log:
        ...
        helpers = {name: sha(Path(__file__).with_name(name)) for name in (
            'teacher_fisher_citeseer_full.py', 'teacher_fisher_nystrom.py', 'diagonal_metric.py',
